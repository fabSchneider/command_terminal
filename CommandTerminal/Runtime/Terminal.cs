...
namespace CommandTerminal
{
    ...
    public class Terminal : MonoBehaviour
    {
        ...
        public void SetToggleAction(InputAction action)
        {
            toggleAction = action;
        }

        public void SetToggleFullAction(InputAction action)
        {
            toggleFullAction = action;
        }
        ...
        void Start()
        {
            ...
            if (toggleAction == null)
                toggleAction = ToggleHotkey ? ToggleHotkey.action : null;
            if (toggleFullAction == null)
                toggleFullAction = ToggleFullHotkey ? ToggleFullHotkey.action : null;
        ...
        void OnGUI()
        {
            ...
            if (toggleFullAction != null && toggleFullAction.WasPressedThisFrame())
            {
                SetState(TerminalState.OpenFull);
                initial_open = true;
            }
            else if (toggleAction != null && toggleAction.WasPressedThisFrame())
            {
